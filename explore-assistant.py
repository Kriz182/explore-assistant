...
vertexai.init(project="you-gcp-project", location="location-plam2")
parameters = {
    "temperature": 0.2,
...
with input:
    ...
    <div style="font-family: 'Roboto', sans-serif; font-weight: 500; font-size:20px;">
                          <img src='https://demo.looker.com/images/favicon.ico' width="30" height="30" alt="Generative AI"/>
                            Hi, I'm your Explore Assistant, I can help build queries : Orders, Items and Customers</div>""", height=50)
    prompt = st.text_input(label="Example : What's my revenue this week ?")
with result:
    if prompt:
        llm = """
input: {}
output: """.format(prompt)
        ...
        if save_logs(prompt, response, "lookai_all_logs.jsonl"):
